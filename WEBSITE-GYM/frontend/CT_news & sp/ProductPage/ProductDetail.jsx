...
export default function ProductDetail() {
  ...
  const handleBuyNow = () => {
    ...
    // Currently just an alert as a placeholder
    alert(`Đã thêm ${quantity} sản phẩm '${product.name}' vào giỏ hàng với tổng tiền: ${(product.price * quantity).toLocaleString('vi-VN')}đ`);
  };
    ...
    <div className="min-h-screen bg-white flex flex-col">
      <div className="w-full max-w-7xl mx-auto px-4 py-8 flex-grow">
        ...
        <div className="flex flex-col md:flex-row gap-12">
          ...
          {/* Left Column: Image */}
          <div className="w-full md:w-1/2 flex items-center justify-center bg-gray-50 rounded-2xl p-8 lg:p-16 border border-gray-100">
            <img 
              src={imageUrl} 
              alt={product.name}
