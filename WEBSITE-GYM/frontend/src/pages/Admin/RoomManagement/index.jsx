          ...
          <table className="w-full text-left text-sm">
            <thead>
              <tr className="bg-gray-700 border-b border-gray-600">
                ...
                <th className="px-6 py-4 text-left text-sm font-semibold text-gray-300">Tên phòng</th>
                <th className="px-6 py-4 text-left text-sm font-semibold text-gray-300">Tổng dụng cụ</th>
                <th className="px-6 py-4 text-left text-sm font-semibold text-gray-300">Danh sách dụng cụ</th>
